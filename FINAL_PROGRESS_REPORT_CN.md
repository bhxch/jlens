...
成功将 Java Maven Classpath MCP 服务器迁移到使用 MCP Java SDK 0.17.2 进行实现。项目现在完全基于官方 MCP Java SDK，不再使用自定义的 MCP 协议实现。
...
- test_mcp_protocol.py - 完整的 MCP 协议集成测试
...
- **JaCoCo 报告**: 已生成在 target/site/jacoco/index.html
