...
import io.github.bhxch.mcp.javastub.config.MavenConfig;
...
class JavaClasspathServerIntegrationTest {
    ...
    void setUp() throws Exception {
        ...
        ProcessBuilder pb = new ProcessBuilder(
            "java",
            "-jar",
            "E:\\repos\\javastub\\target\\javastub-mcp-server-1.0.0-SNAPSHOT.jar"
        );
    ...
    void testInspectJavaClassWithSourceFile() {
        String request = "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"tools/call\",\"params\":{\"name\":\"inspect_java_class\",\"arguments\":{\"className\":\"io.github.bhxch.mcp.javastub.Main\",\"sourceFilePath\":\"E:\\\\repos\\\\javastub\\\\src\\\\main\\\\java\\\\io\\\\github\\\\bhxch\\\\mcp\\\\javastub\\\\Main.java\",\"detailLevel\":\"basic\"}}}\n";
        String response = assertDoesNotThrow(() -> sendRequest(request));
        assertNotNull(response);
        assertTrue(response.contains("Main") || response.contains("io.github.bhxch.mcp.javastub"), "Response should contain class information");
    }
    ...
    void testListModuleDependencies() {
        String request = "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"tools/call\",\"params\":{\"name\":\"list_module_dependencies\",\"arguments\":{\"pomFilePath\":\"E:\\\\repos\\\\javastub\\\\pom.xml\",\"scope\":\"compile\"}}}\n";
        String response = assertDoesNotThrow(() -> sendRequest(request));
    ...
    void testListModuleDependenciesWithSourceFile() {
        String request = "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"tools/call\",\"params\":{\"name\":\"list_module_dependencies\",\"arguments\":{\"sourceFilePath\":\"E:\\\\repos\\\\javastub\\\\src\\\\main\\\\java\\\\io\\\\github\\\\bhxch\\\\mcp\\\\javastub\\\\Main.java\",\"scope\":\"compile\"}}}\n";
        String response = assertDoesNotThrow(() -> sendRequest(request));
    ...
    void testListModuleDependenciesWithTestScope() {
        String request = "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"tools/call\",\"params\":{\"name\":\"list_module_dependencies\",\"arguments\":{\"pomFilePath\":\"E:\\\\repos\\\\javastub\\\\pom.xml\",\"scope\":\"test\"}}}\n";
        String response = assertDoesNotThrow(() -> sendRequest(request));
        assertNotNull(response);
    ...
    void testListModuleDependenciesInvalidFile() {
        String request = "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"tools/call\",\"params\":{\"name\":\"list_module_dependencies\",\"arguments\":{\"pomFilePath\":\"E:\\\\repos\\\\javastub\\\\nonexistent\\\\pom.xml\",\"scope\":\"compile\"}}}\n";
        String response = assertDoesNotThrow(() -> sendRequest(request));
        assertNotNull(response);
    ...
    void testSearchJavaClassWildcard() {
        String request = "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"tools/call\",\"params\":{\"name\":\"search_java_class\",\"arguments\":{\"classNamePattern\":\"*List*\",\"sourceFilePath\":\"E:\\\\repos\\\\javastub\\\\src\\\\main\\\\java\\\\io\\\\github\\\\bhxch\\\\mcp\\\\javastub\\\\Main.java\",\"searchType\":\"wildcard\",\"limit\":10}}}\n";
        String response = assertDoesNotThrow(() -> sendRequest(request));
        assertNotNull(response);
    ...
    void testSearchJavaClassPrefix() {
        String request = "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"tools/call\",\"params\":{\"name\":\"search_java_class\",\"arguments\":{\"classNamePattern\":\"String\",\"sourceFilePath\":\"E:\\\\repos\\\\javastub\\\\src\\\\main\\\\java\\\\io\\\\github\\\\bhxch\\\\mcp\\\\javastub\\\\Main.java\",\"searchType\":\"prefix\",\"limit\":5}}}\n";
        String response = assertDoesNotThrow(() -> sendRequest(request));
        assertNotNull(response);
    ...
    void testSearchJavaClassExact() {
        String request = "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"tools/call\",\"params\":{\"name\":\"search_java_class\",\"arguments\":{\"classNamePattern\":\"Map\",\"sourceFilePath\":\"E:\\\\repos\\\\javastub\\\\src\\\\main\\\\java\\\\io\\\\github\\\\bhxch\\\\mcp\\\\javastub\\\\Main.java\",\"searchType\":\"exact\",\"limit\":10}}}\n";
        String response = assertDoesNotThrow(() -> sendRequest(request));
        assertNotNull(response);
    ...
    void testSearchJavaClassProjectClasses() {
        String request = "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"tools/call\",\"params\":{\"name\":\"search_java_class\",\"arguments\":{\"classNamePattern\":\"*Handler*\",\"sourceFilePath\":\"E:\\\\repos\\\\javastub\\\\src\\\\main\\\\java\\\\io\\\\github\\\\bhxch\\\\mcp\\\\javastub\\\\Main.java\",\"searchType\":\"wildcard\",\"limit\":10}}}\n";
        String response = assertDoesNotThrow(() -> sendRequest(request));
        assertNotNull(response);
    ...
    void testBuildModuleDefaultGoals() {
        String request = "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"tools/call\",\"params\":{\"name\":\"build_module\",\"arguments\":{\"sourceFilePath\":\"E:\\\\repos\\\\javastub\\\\src\\\\main\\\\java\\\\io\\\\github\\\\bhxch\\\\mcp\\\\javastub\\\\Main.java\"}}}\n";
        String response = assertDoesNotThrow(() -> sendRequest(request));
        assertNotNull(response);
    ...
    void testBuildModuleWithSourceDownload() {
        String request = "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"tools/call\",\"params\":{\"name\":\"build_module\",\"arguments\":{\"sourceFilePath\":\"E:\\\\repos\\\\javastub\\\\src\\\\main\\\\java\\\\io\\\\github\\\\bhxch\\\\mcp\\\\javastub\\\\Main.java\",\"downloadSources\":true,\"goals\":[\"compile\"]}}}\n";
        String response = assertDoesNotThrow(() -> sendRequest(request));
        assertNotNull(response);
        assertTrue(response.contains("BUILD") || response.contains("build") || response.contains("exitCode"), "Response should contain build information");
    }
    ...
    void testBuildModuleCustomGoals() {
        String request = "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"tools/call\",\"params\":{\"name\":\"build_module\",\"arguments\":{\"sourceFilePath\":\"E:\\\\repos\\\\javastub\\\\src\\\\main\\\\java\\\\io\\\\github\\\\bhxch\\\\mcp\\\\javastub\\\\Main.java\",\"goals\":[\"clean\",\"test-compile\"]}}}\n";
        String response = assertDoesNotThrow(() -> sendRequest(request));
        assertNotNull(response);
        assertTrue(response.contains("BUILD") || response.contains("build") || response.contains("exitCode"), "Response should contain build information");
    }
    ...
    void testCompleteWorkflow() {
        ...
        String searchRequest = "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"tools/call\",\"params\":{\"name\":\"search_java_class\",\"arguments\":{\"classNamePattern\":\"*List*\",\"sourceFilePath\":\"E:\\\\repos\\\\javastub\\\\src\\\\main\\\\java\\\\io\\\\github\\\\bhxch\\\\mcp\\\\javastub\\\\Main.java\",\"searchType\":\"wildcard\",\"limit\":5}}}\n";
    ...
    void testErrorRecovery() {
        ...
        String searchRequest = "{\"jsonrpc\":\"2.0\",\"id\":2,\"method\":\"tools/call\",\"params\":{\"name\":\"search_java_class\",\"arguments\":{\"classNamePattern\":\"*Class*\",\"sourceFilePath\":\"E:\\\\repos\\\\javastub\\\\src\\\\main\\\\java\\\\io\\\\github\\\\bhxch\\\\mcp\\\\javastub\\\\Main.java\",\"searchType\":\"wildcard\",\"limit\":10}}}\n";
        String searchResponse = assertDoesNotThrow(() -> sendRequest(searchRequest));
        assertNotNull(searchResponse);
    ...
    void testDependencyResolutionAndBuild() {
        ...
        String listRequest1 = "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"tools/call\",\"params\":{\"name\":\"list_module_dependencies\",\"arguments\":{\"pomFilePath\":\"E:\\\\repos\\\\javastub\\\\pom.xml\",\"scope\":\"compile\"}}}\n";
        String result1 = assertDoesNotThrow(() -> sendRequest(listRequest1));
        assertNotNull(result1);

        // Step 2: Build module
        String buildRequest = "{\"jsonrpc\":\"2.0\",\"id\":2,\"method\":\"tools/call\",\"params\":{\"name\":\"build_module\",\"arguments\":{\"sourceFilePath\":\"E:\\\\repos\\\\javastub\\\\src\\\\main\\\\java\\\\io\\\\github\\\\bhxch\\\\mcp\\\\javastub\\\\Main.java\",\"goals\":[\"compile\"]}}}\n";
        ...
        String listRequest2 = "{\"jsonrpc\":\"2.0\",\"id\":3,\"method\":\"tools/call\",\"params\":{\"name\":\"list_module_dependencies\",\"arguments\":{\"pomFilePath\":\"E:\\\\repos\\\\javastub\\\\pom.xml\",\"scope\":\"compile\"}}}\n";
