package io.github.bhxch.mcp.javastub.unit.config;
...
class ServerConfigTest {
    ...
    void testDecompilerConfig() {
        ServerConfig config = new ServerConfig();
        config.getDecompilerConfig().setDecompilerType(io.github.bhxch.mcp.javastub.config.DecompilerConfig.DecompilerType.CFR);

        assertEquals(io.github.bhxch.mcp.javastub.config.DecompilerConfig.DecompilerType.CFR,
