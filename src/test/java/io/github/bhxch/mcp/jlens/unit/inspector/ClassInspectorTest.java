package io.github.bhxch.mcp.jlens.unit.inspector;
...
class ClassInspectorTest {
    ...
    void testInspectSimpleClassName() {
        ClassMetadata metadata = inspector.inspect("TestClass", null,
            io.github.bhxch.mcp.jlens.concurrent.ParallelProcessor.DetailLevel.BASIC, null);
    ...
    void testInspectWithSourceFile() {
        ...
        ClassMetadata metadata = inspector.inspect("com.example.TestClass", null,
            io.github.bhxch.mcp.jlens.concurrent.ParallelProcessor.DetailLevel.BASIC, sourceFile);
    ...
    void testDifferentDetailLevels() {
        for (io.github.bhxch.mcp.jlens.concurrent.ParallelProcessor.DetailLevel level :
             io.github.bhxch.mcp.jlens.concurrent.ParallelProcessor.DetailLevel.values()) {
    ...
    void testWithModuleContext() {
        ...
        ClassMetadata metadata = inspector.inspect("com.example.TestClass", context,
            io.github.bhxch.mcp.jlens.concurrent.ParallelProcessor.DetailLevel.FULL, null);
