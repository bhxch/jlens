...
- **File**: `src/main/java/io/github/bhxch/mcp/javastub/classpath/PackageMappingResolver.java`
- **Features**:
...
- **File**: `src/test/java/io/github/bhxch/mcp/javastub/unit/classpath/PackageMappingResolverTest.java`
- **Coverage**:
...
- **File**: `src/main/java/io/github/bhxch/mcp/javastub/dependency/DependencyManager.java`
- **Features**:
...
#### 2.2 MavenBuilder ✅
- **File**: `src/main/java/io/github/bhxch/mcp/javastub/dependency/MavenBuilder.java`
- **Features**:
...
- **File**: `src/test/java/io/github/bhxch/mcp/javastub/unit/dependency/MavenBuilderTest.java`
- **Coverage**:
...
- **File**: `src/main/java/io/github/bhxch/mcp/javastub/intelligence/BuildPromptGenerator.java`
- **Features**:
...
- **File**: `src/test/java/io/github/bhxch/mcp/javastub/unit/intelligence/BuildPromptGeneratorTest.java`
- **Coverage**:
...
- **File**: `src/main/java/io/github/bhxch/mcp/javastub/server/handlers/SearchJavaClassHandler.java`
- **Features**:
...
- **File**: `src/main/java/io/github/bhxch/mcp/javastub/server/handlers/BuildModuleHandler.java`
- **Features**:
...
- **File**: `src/main/java/io/github/bhxch/mcp/javastub/server/JavaClasspathServer.java`
- **Changes**:
...
### New Source Files (10)
1. `src/main/java/io/github/bhxch/mcp/javastub/classpath/PackageMappingResolver.java`
2. `src/main/java/io/github/bhxch/mcp/javastub/dependency/DependencyManager.java`
3. `src/main/java/io/github/bhxch/mcp/javastub/dependency/MavenBuilder.java`
4. `src/main/java/io/github/bhxch/mcp/javastub/intelligence/BuildPromptGenerator.java`
5. `src/main/java/io/github/bhxch/mcp/javastub/server/handlers/SearchJavaClassHandler.java`
6. `src/main/java/io/github/bhxch/mcp/javastub/server/handlers/BuildModuleHandler.java`

### Modified Source Files (2)
1. `src/main/java/io/github/bhxch/mcp/javastub/server/JavaClasspathServer.java`
2. `src/main/java/io/github/bhxch/mcp/javastub/maven/model/ModuleContext.java`

### New Test Files (3)
1. `src/test/java/io/github/bhxch/mcp/javastub/unit/dependency/MavenBuilderTest.java`
2. `src/test/java/io/github/bhxch/mcp/javastub/unit/classpath/PackageMappingResolverTest.java`
3. `src/test/java/io/github/bhxch/mcp/javastub/unit/intelligence/BuildPromptGeneratorTest.java`
